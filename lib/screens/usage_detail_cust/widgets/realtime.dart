...
import 'package:pgn_mobile/screens/usage_detail_cust/widgets/realtime_detail.dart';
import 'dart:async';
import 'dart:convert';
...
class Realtime extends StatefulWidget {
  ...
  Realtime({this.title, this.idCust});
  @override
  RealtimeState createState() => RealtimeState(title, idCust);
}

class RealtimeState extends State<Realtime> with TickerProviderStateMixin {
  final String title, idCust;
  DataSpbg data;
  RealtimeState(this.title, this.idCust);
  String groupID;
...
Future<ChartUsageDetailRealtime> fetchGetChar(
  ...
  var responseUsageChar = await http.get(
    '${UrlCons.mainProdUrl}customers/me/gas-usages/realtime-chart',
    headers: {
