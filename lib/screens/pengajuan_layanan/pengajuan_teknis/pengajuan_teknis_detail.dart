...
class PengajuanTeknisDetail extends StatefulWidget {
  final int id;
  PengajuanTeknisDetail({this.id});
  @override
  _PengajuanTeknisDetailState createState() =>
      _PengajuanTeknisDetailState(id: id);
}

class _PengajuanTeknisDetailState extends State<PengajuanTeknisDetail> {
  final int id;
  _PengajuanTeknisDetailState({this.id});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Layanan Teknis Detail',
          style: TextStyle(color: Colors.white, fontSize: 16),
        ),
      ),
      body: FutureBuilder<DetailData>(
          future: getFuturePengajuanTeknisDetail(),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.techTye}'),
                              ),
                            ),
                          ],
                        ),
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin menghapus pengajuan layanan teknis ini ? ",
            style: TextStyle(
  ...
  Future<DetailData> getFuturePengajuanTeknisDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/technical-service/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
