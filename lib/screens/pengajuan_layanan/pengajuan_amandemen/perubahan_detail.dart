...
class SegmenDetail extends StatefulWidget {
  final int id;
  SegmenDetail({this.id});
  @override
  _SegmenDetailState createState() => _SegmenDetailState(id: id);
}

class _SegmenDetailState extends State<SegmenDetail> {
  final int id;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Perubahan Segmen/Kelompok Pelanggan Detail',
          style: TextStyle(color: Colors.white, fontSize: 16),
        ),
      ),
      body: FutureBuilder<DetailData>(
          future: getFutureSegmenDetail(),
                  ...
                  child: ListView(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Jenis Pemakaian Gas'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Volume Minimum/bulan'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.minMonth}'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Volume Maksimum/bulan'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.maxMonth}'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Volume Rata-rata/bulan'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.avgMonth}'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Jumlah Jam operasional/hari'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.hourDay}'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Jumlah Hari operasional/minggu'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.dayWeek}'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Text('Daftar Peralatan Gas dan Jumlah Unit',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      ListView.builder(
                        shrinkWrap: true,
                        physics: NeverScrollableScrollPhysics(),
                        itemCount: snapshot.data.custEquip.datasEquip.length,
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  width: 150,
                                  child: Text(
                                      '${snapshot.data.custEquip.datasEquip[i].name}'),
                                ),
                                Container(
                                  margin: const EdgeInsets.only(left: 10),
                                  width: 10,
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsets.only(left: 2),
                                    child: Text(
                                        '${snapshot.data.custEquip.datasEquip[i].val}'),
                                  ),
                                ),
                              ],
                            ),
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          PengajuanAmandemenSegmenUpdate(
                                              id: widget.id),
                                    ),
                                  ).then((value) => setState(() {}));
                                },
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin menghapus Perubahan Segmen/Kelompok Pelanggan ini? ",
            style: TextStyle(
  ...
  Future<DetailData> getFutureSegmenDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/change-segment/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
