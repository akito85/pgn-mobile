...
import 'package:pgn_mobile/screens/pengajuan_layanan/pengajuan_amandemen/bbg_detail.dart';
import 'package:pgn_mobile/screens/pengajuan_layanan/pengajuan_amandemen/pengajuan_amandemen_form.dart';

class BBGList extends StatefulWidget {
  @override
  _BBGListState createState() => _BBGListState();
}

class _BBGListState extends State<BBGList> {
  String userName = '';
  String userID = '';
  String nextPage = '';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ListView(
          children: [
            FutureBuilder<BBGModel>(
              future: getFutureBBGList(),
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => BBGDetail(id: datas[i].id),
                          ),
                        ).then((value) => setState(() {
                              datas.clear();
                              nextPage = '';
  ...
  void loadMore() async {
    ...
    BBGModel returnData =
        BBGModel.fromJson(json.decode(responseGetSubsProg.body));
