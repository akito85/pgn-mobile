...
class PemasanganKembaliForm extends StatefulWidget {
  @override
  _PemasanganKembaliFormState createState() => _PemasanganKembaliFormState();
}

class _PemasanganKembaliFormState extends State<PemasanganKembaliForm> {
  List listGenderType = [
    "Laki-Laki",
    "Perempuan",
  ];
  ...
  void submitForm() async {
    ...
    var body = json.encode({
      ...
      "info_media": '',
      "submission_date": selectedPemasangan != null
          ? DateFormat('yyy-MM-dd').format(selectedPemasangan)
