...
import 'package:pgn_mobile/screens/pengajuan_layanan/pemasangan_kembali/pemasangan_kembali_update.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class PemasanganKembaliDetail extends StatefulWidget {
  final int id;
  PemasanganKembaliDetail({this.id});
  @override
  _PemasanganKembaliDetailState createState() =>
      _PemasanganKembaliDetailState(id: id);
}

class _PemasanganKembaliDetailState extends State<PemasanganKembaliDetail> {
  final int id;
  _PemasanganKembaliDetailState({this.id});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<DetailData>(
          future: getFuturePemasanganKembaliDetail(),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Tanggal Pemasangan Kembali'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin menghapus pengajuan pemasangan kembali ini ? ",
            style: TextStyle(
  ...
  Future<DetailData> getFuturePemasanganKembaliDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/resubscribe/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
