...
import 'package:pgn_mobile/screens/pengajuan_layanan/pemasangan_kembali/pemasangan_kembali_detail.dart';
import 'package:pgn_mobile/screens/pengajuan_layanan/pemasangan_kembali/pemasangan_kembali_form.dart';

class PemasanganKembaliList extends StatefulWidget {
  @override
  _PemasanganKembaliListState createState() => _PemasanganKembaliListState();
}

class _PemasanganKembaliListState extends State<PemasanganKembaliList> {
  String userName = '';
  String userID = '';
  String nextPage = '';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ListView(
            children: [
              FutureBuilder<PemasanganKembaliModel>(
                future: getFuturePemasanganKembaliList(),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PemasanganKembaliDetail(id: datas[i].id),
                            ),
                          ).then((value) => setState(() {
                                datas.clear();
                                nextPage = '';
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PemasanganKembaliForm(),
                    ),
                  ).then((value) => setState(() {
                        datas.clear();
                        nextPage = '';
  ...
  void loadMore() async {
    ...
    var response = await http.get(
        '${UrlCons.mainDevUrl}customer-service/resubscribe?per_page=10&next_page=$nextPage',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken',
          'Accept-Language': lang,
        });
    PemasanganKembaliModel returnData =
        PemasanganKembaliModel.fromJson(json.decode(response.body));
  ...
  Future<PemasanganKembaliModel> getFuturePemasanganKembaliList() async {
    ...
    String lang = await storageCache.read(key: 'lang');
    var response = await http.get(
        '${UrlCons.mainDevUrl}customer-service/resubscribe?per_page=10',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken',
          'Accept-Language': lang,
