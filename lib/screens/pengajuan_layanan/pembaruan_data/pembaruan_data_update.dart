...
class PembaruanDPelangganUpdate extends StatefulWidget {
  final int id;
  PembaruanDPelangganUpdate({this.id});
  @override
  _PembaruanDPelangganUpdateState createState() =>
      _PembaruanDPelangganUpdateState(id: id);
}

class _PembaruanDPelangganUpdateState extends State<PembaruanDPelangganUpdate> {
  final int id;
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin perbarui pengajuan pembaruan data pelanggan? ",
            style: TextStyle(
  ...
  void getData() async {
    ...
    numberNpwpCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailData.nomorNpwp))
        .value;
    kabupatenCtrl.value = new TextEditingController.fromValue(
  ...
  void submitForm() async {
    ...
    var response = await http.put(
        '${UrlCons.mainProdUrl}customer-service/update-data-customer/$id',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken'
        },
