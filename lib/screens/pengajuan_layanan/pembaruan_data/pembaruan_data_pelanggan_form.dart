...
class PembaruanDPelangganForm extends StatefulWidget {
  @override
  _PembaruanDPelangganFormState createState() =>
      _PembaruanDPelangganFormState();
}
...
class _PembaruanDPelangganFormState extends State<PembaruanDPelangganForm> {
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin melakukan pengajuan pembaruan data pelanggan? ",
            style: TextStyle(
  ...
  void submitForm() async {
    ...
    var response = await http.post(
        '${UrlCons.mainProdUrl}customer-service/update-data-customer',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken'
        },
        body: body);
    print('INI HASIL POST CREATE PEMBAURAN DATA ${response.body}');
