...
class BerhentiBerlanggananUpdate extends StatefulWidget {
  final int id;
  BerhentiBerlanggananUpdate({this.id});
  @override
  _BerhentiBerlanggananUpdateState createState() =>
      _BerhentiBerlanggananUpdateState(id: id);
}

class _BerhentiBerlanggananUpdateState
    extends State<BerhentiBerlanggananUpdate> {
  final int id;
  _BerhentiBerlanggananUpdateState({this.id});
  DetailBerhetiBerlangganan detailBerhetiBerlanggananData =
      new DetailBerhetiBerlangganan();
  var splitString;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Update Pengajuan Berhenti Berlangganan',
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    '${detailBerhetiBerlanggananData.custName}',
                                hintStyle: TextStyle(color: Colors.black),
                                contentPadding: new EdgeInsets.symmetric(
                                    vertical: 12.0, horizontal: 15.0),
                                disabledBorder: OutlineInputBorder(
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        keyboardType: TextInputType.text,
                        decoration: InputDecoration(
                          hintText: '${detailBerhetiBerlanggananData.email}',
                          hintStyle: TextStyle(color: Colors.black),
                          contentPadding: new EdgeInsets.symmetric(
                              vertical: 12.0, horizontal: 15.0),
                          disabledBorder: OutlineInputBorder(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          detailBerhetiBerlanggananData.npwpFile == ""
                              ? GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      _fileName = null;
                    ...
                    Padding(
                      ...
                      child: DottedBorder(
                        ...
                        strokeWidth: 1,
                        child: detailBerhetiBerlanggananData.npwpFile == ""
                            ? Container(
                                height: 60,
                                child: Center(
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin perbarui pengajuan berhenti berlangganan ini? ",
            style: TextStyle(
  ...
  void getData() async {
    ...
    var responseGetBerhentiBerlangganan = await http.get(
        '${UrlCons.mainDevUrl}customer-service/unsubscribe/${widget.id}',
        headers: {
    ...
    if (detailBerhetiBerlangganan.npwpFile != "") {
      splitString = detailBerhetiBerlangganan.npwpFile.split(',');
      image = base64.decode(splitString[1]);
    }

    setState(() {
      detailBerhetiBerlanggananData = detailBerhetiBerlangganan;
    ...
    tempatLahirCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.bPlace))
        .value;
    valueChoose = detailBerhetiBerlangganan.gender;
    selected = DateTime.parse(detailBerhetiBerlangganan.bDate).toLocal();
    alamatCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.address))
        .value;
    perumahanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.street))
        .value;
    rtCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.rt))
        .value;
    rwCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.rw))
        .value;
    kelurahanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.kelurahan))
        .value;
    kecamatanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.kecamatan))
        .value;
    ...
    provinsiCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.prov))
        .value;
    kodeposCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.postalCode))
        .value;
    locationCtrl
        .value = new TextEditingController.fromValue(new TextEditingValue(
            text:
                '${detailBerhetiBerlangganan.lat},${detailBerhetiBerlangganan.long}'))
        .value;
    statusLokasi = detailBerhetiBerlangganan.locStat;
    selectedPengajuan =
        DateTime.parse(detailBerhetiBerlangganan.subDate).toLocal();
    alasanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.reason))
        .value;
    ktpAddressCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.ktpAddress))
        .value;
    numberNpwpCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.npwpNumb))
        .value;
    kabupatenCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailBerhetiBerlangganan.kabupaten))
        .value;
  ...
  void updateForm() async {
    ...
    // var responses = http.MultipartRequest("PUT",
    //     Uri.parse('${UrlCons.mainProdUrl}customer-service/unsubscribe/$id'));
    ...
    // responses.fields['customer_id'] = detailBerhetiBerlanggananData.custId;
    // responses.fields['customer_name'] = detailBerhetiBerlanggananData.custName;
    ...
    // responses.fields['email'] = detailBerhetiBerlanggananData.email;
    // responses.fields['phone_number'] = detailBerhetiBerlanggananData.phoneNumb;
    ...
    var body = json.encode({
      "customer_id": detailBerhetiBerlanggananData.custId,
      "customer_name": detailBerhetiBerlanggananData.custName,
      "gender": valueChoose,
      ...
      "submission_date": selectedPengajuan != null
          ? DateFormat('yyy-MM-dd').format(selectedPengajuan)
          : detailBerhetiBerlanggananData.subDate,
    ...
    var responseCreateBerhentiBerlangganan = await http.put(
        '${UrlCons.mainProdUrl}customer-service/unsubscribe/$id',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken'
        },
