...
class BerhentiBerlanggananDetail extends StatefulWidget {
  final int id;
  BerhentiBerlanggananDetail({this.id});
  @override
  _BerhentiBerlanggananDetailState createState() =>
      _BerhentiBerlanggananDetailState(id: id);
}

class _BerhentiBerlanggananDetailState
    extends State<BerhentiBerlanggananDetail> {
  final int id;
  _BerhentiBerlanggananDetailState({this.id});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<DetailBerhetiBerlangganan>(
          future: getFutureBerhentiBerlangganDetail(),
  ...
  Future<DetailBerhetiBerlangganan> getFutureBerhentiBerlangganDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/unsubscribe/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
    ...
    CreateBerhentiBerlangganan deleteFormId =
