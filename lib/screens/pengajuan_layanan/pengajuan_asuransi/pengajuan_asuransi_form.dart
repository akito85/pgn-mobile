...
class PengajuanAsuransiForm extends StatefulWidget {
  @override
  _PengajuanAsuransiFormState createState() => _PengajuanAsuransiFormState();
}
...
class _PengajuanAsuransiFormState extends State<PengajuanAsuransiForm> {
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(selectedPengajuan != null
                            ? DateFormat('d MMM yyy').format(selectedPengajuan)
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin melakukan pengajuan asuransi kebakaran? ",
            style: TextStyle(
  ...
  void submitForm() async {
    ...
    var response = await http.post(
        '${UrlCons.mainProdUrl}customer-service/fire-insurance-application',
        headers: {
          'Content-Type': 'application/json',
