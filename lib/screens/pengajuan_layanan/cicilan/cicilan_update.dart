...
class CicilanUpdate extends StatefulWidget {
  final int id;
  CicilanUpdate({this.id});
  @override
  _CicilanUpdateState createState() => _CicilanUpdateState(id: id);
}

class _CicilanUpdateState extends State<CicilanUpdate> {
  final int id;
  _CicilanUpdateState({this.id});
  ...
  DateTime selectedPemasangan = DateTime.now();
  String valueChoose;
  String valueMediaType;
  String valueCicilanType;
  ...
  TextEditingController totalNilaiCtrl = new TextEditingController();
  TextEditingController banyakCicilanCtrl = new TextEditingController();
  TextEditingController besarPerCicilanCtrl = new TextEditingController();
  ...
  Future _showDatePickerPemasangan() async {
    dynamic selectedPicker = await showDatePicker(
      context: context,
      initialDate: DateTime.now(),
      firstDate: DateTime(1960),
    ...
    setState(() {
      selectedPemasangan = selectedPicker;
    });
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        keyboardType: TextInputType.text,
                        decoration: InputDecoration(
                          hintText: detailDatas.custGroup,
                          hintStyle: TextStyle(color: Colors.black),
                          contentPadding: new EdgeInsets.symmetric(
                              vertical: 12.0, horizontal: 15.0),
                          disabledBorder: OutlineInputBorder(
                      ...
                      child: Padding(
                        ...
                        child: DropdownButton(
                          ...
                          style: TextStyle(
                              ...
                              fontSize: 14,
                              fontWeight: FontWeight.normal),
                          value: valueCicilanType,
                          onChanged: (newValue) {
                            setState(() {
                              valueCicilanType = newValue;
                            });
                          },
                          items: listCicilanType.map((valueItem) {
                            return DropdownMenuItem(
                                value: valueItem, child: Text(valueItem));
                          }).toList(),
                        ),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          double besaranCicilan;
                          besaranCicilan = double.parse(totalNilaiCtrl.text) /
                              double.parse(banyakCicilanCtrl.text);
                          besarPerCicilanCtrl.text =
                              besaranCicilan.toStringAsFixed(0);
                        },
                        decoration: InputDecoration(
                          suffixIcon: Text("\Kali    "),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        keyboardType: TextInputType.number,
                        controller: besarPerCicilanCtrl,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Data tidak boleh kosong!';
                          }
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          Text(selectedPemasangan != null
                              ? DateFormat('d MMM yyy')
                                  .format(selectedPemasangan)
                              : DateFormat('d MMM yyy').format(
                                  DateTime.parse(detailDatas.loanInstallDate)
                                      .toLocal())),
                          Expanded(
                            child: Container(
                              alignment: Alignment.centerRight,
  ...
  void getData() async {
    ...
    var response = await http.get(
        '${UrlCons.mainDevUrl}customer-service/loan/${widget.id}',
        headers: {
    ...
    kabupatenCtrl.value = new TextEditingController.fromValue(
        ...
        .value;
    totalNilaiCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailData.totalValue))
        .value;
    banyakCicilanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailData.numberLoanInstallment))
        .value;
    besarPerCicilanCtrl.value = new TextEditingController.fromValue(
            new TextEditingValue(text: detailData.amountLoan))
        .value;
    selectedPemasangan = DateTime.parse(detailData.loanInstallDate).toLocal();
  ...
  void submitForm() async {
    ...
    var body = json.encode({
      ...
      "loan_type": valueCicilanType,
      "total_value": totalNilaiCtrl.text,
      "number_of_loan_installment": banyakCicilanCtrl.text,
      "amount_of_loan_installment": besarPerCicilanCtrl.text,
