...
import 'package:pgn_mobile/screens/pengajuan_layanan/cicilan/cicilan_update.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class CicilanDetail extends StatefulWidget {
  final int id;
  CicilanDetail({this.id});
  @override
  _CicilanDetailState createState() => _CicilanDetailState(id: id);
}

class _CicilanDetailState extends State<CicilanDetail> {
  final int id;
  _CicilanDetailState({this.id});
      ...
      body: FutureBuilder<DetailData>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.data.ktpFile != "") {
              splitStringKtp = snapshot.data.ktpFile.split(',');
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.loanType}'),
                              ),
                            ),
                          ],
                        ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.totalValue}'),
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text(
                                    '${snapshot.data.numberLoanInstallment} Kali'),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 150,
                              child: Text('Besaran per Cicilan'),
                            ),
                            Container(
                              margin: const EdgeInsets.only(left: 10),
                              width: 10,
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text('${snapshot.data.amountLoan}'),
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 2),
                                child: Text(
                                    '${DateFormat('dd MMMM yyy').format(DateTime.parse(snapshot.data.loanInstallDate).toLocal())}'),
                              ),
                            ),
                          ],
                        ),
  ...
  Future<DetailData> getFutureCicilanDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/loan/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
