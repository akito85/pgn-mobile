...
import 'package:pgn_mobile/screens/pengajuan_layanan/pengaliran_kembali/pengaliran_kembali_detail.dart';
import 'package:pgn_mobile/screens/pengajuan_layanan/pengaliran_kembali/pengaliran_kembali_form.dart';

class PengaliranKembaliList extends StatefulWidget {
  @override
  _PengaliranKembaliListState createState() => _PengaliranKembaliListState();
}

class _PengaliranKembaliListState extends State<PengaliranKembaliList> {
  String userName = '';
  String userID = '';
  String nextPage = '';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ListView(
            children: [
              FutureBuilder<PengaliranKembaliModel>(
                future: getFuturePengaliranKembaliList(),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PengaliranKembaliDetail(id: datas[i].id),
                            ),
                          ).then((value) => setState(() {
                                datas.clear();
                                nextPage = '';
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PengaliranKembaliForm(),
                    ),
                  ).then((value) => setState(() {
                        datas.clear();
                        nextPage = '';
  ...
  void loadMore() async {
    ...
    var responseGetSubsProg = await http.get(
        '${UrlCons.mainDevUrl}customer-service/reflow?per_page=10&next_page=$nextPage',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken',
          'Accept-Language': lang,
        });
    PengaliranKembaliModel returnData =
        PengaliranKembaliModel.fromJson(json.decode(responseGetSubsProg.body));
