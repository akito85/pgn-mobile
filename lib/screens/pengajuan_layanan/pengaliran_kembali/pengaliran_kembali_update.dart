...
import 'package:pgn_mobile/screens/pengajuan_layanan/widgets/widget_pengaliran_kembali.dart';
import 'package:pgn_mobile/screens/register/widgets/map_point.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class PengaliranKembaliUpdate extends StatefulWidget {
  final int id;
  PengaliranKembaliUpdate({this.id});
  @override
  _PengaliranKembaliUpdateState createState() =>
      _PengaliranKembaliUpdateState(id: id);
}

class _PengaliranKembaliUpdateState extends State<PengaliranKembaliUpdate> {
  final int id;
  _PengaliranKembaliUpdateState({this.id});
    ...
    return Alert(
      ...
      content: Column(
        children: <Widget>[
          SizedBox(height: 5),
          Text(
            "Anda yakin ingin perbarui pengajuan pengaliran kembali ? ",
            style: TextStyle(
  ...
  void getData() async {
    ...
    var response = await http.get(
        '${UrlCons.mainDevUrl}customer-service/reflow/${widget.id}',
        headers: {
    ...
    selectedPengaliran = DateTime.parse(detailData.subDate).toLocal();
  ...
  void submitForm() async {
    ...
    var body = json.encode({
      ...
      "info_media": '',
      "submission_date": selectedPengaliran != null
    ...
    var response = await http.put(
        '${UrlCons.mainProdUrl}customer-service/reflow/$id',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $accessToken'
        },
