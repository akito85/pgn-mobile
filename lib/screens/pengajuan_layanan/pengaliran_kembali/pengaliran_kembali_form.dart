...
class PengaliranKembaliForm extends StatefulWidget {
  @override
  _PengaliranKembaliFormState createState() => _PengaliranKembaliFormState();
}

class _PengaliranKembaliFormState extends State<PengaliranKembaliForm> {
  List listGenderType = [
    "Laki-Laki",
    "Perempuan",
  ];
  ...
  void submitForm() async {
    ...
    var response = await http.post(
        '${UrlCons.mainProdUrl}customer-service/reflow',
        headers: {
          'Content-Type': 'application/json',
