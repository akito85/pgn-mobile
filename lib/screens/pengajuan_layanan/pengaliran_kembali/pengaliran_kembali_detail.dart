...
import 'package:pgn_mobile/screens/pengajuan_layanan/pengaliran_kembali/pengaliran_kembali_update.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class PengaliranKembaliDetail extends StatefulWidget {
  final int id;
  PengaliranKembaliDetail({this.id});
  @override
  _PengaliranKembaliDetailState createState() =>
      _PengaliranKembaliDetailState(id: id);
}

class _PengaliranKembaliDetailState extends State<PengaliranKembaliDetail> {
  final int id;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<DetailData>(
          future: getFuturePengaliranKembaliDetail(),
  ...
  Future<DetailData> getFuturePengaliranKembaliDetail() async {
  ...
  void deleteFormId() async {
    ...
    var responseDeleteCustId = await http.delete(
      '${UrlCons.mainProdUrl}customer-service/reflow/${widget.id}',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $accessToken',
        'Accept-Language': lang
