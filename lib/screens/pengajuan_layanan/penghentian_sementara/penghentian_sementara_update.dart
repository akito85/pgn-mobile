...
class PenghentianPengaliranUpdate extends StatefulWidget {
  final int id;
  PenghentianPengaliranUpdate({this.id});
  @override
  _PenghentianPengaliranUpdateState createState() =>
      _PenghentianPengaliranUpdateState(id: id);
}

class _PenghentianPengaliranUpdateState
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          Text(selectedPenghentian != null
                              ? DateFormat('d MMM yyy')
                                  .format(selectedPenghentian)
                              : detailDatas.subDateSuspend),
                          Expanded(
                            child: Container(
                              alignment: Alignment.centerRight,
                              child: IconButton(
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: Text(
                              'Apakah Anda membutuhkan pencabutan Meter gas yang terpasang di lokasi Anda?',
                              style: TextStyle(
                                  color: Color(0xFF455055),
                                  fontWeight: FontWeight.bold),
                            ),
                        ...
                        Padding(
                          ...
                          child: Text(isSwitched == true ? 'Ya' : 'Tidak'),
                        ),
                        Container(
  ...
  void getData() async {
    ...
    setState(() {
      ...
      nik = detailData.nik;
      isSwitched = detailDatas.needPlugin == 0 ? false : true;
  ...
  void submitForm() async {
    ...
    var body = json.encode({
      ...
      "info_media": '',
      "submission_suspend_date": selectedPenghentian != null
          ? DateFormat('yyy-MM-dd').format(selectedPenghentian)
          : detailDatas.subDateSuspend,
      "submission_enable_date": selectedPengaliran != null
      ...
      "need_unplug_meter": isSwitched == true ? "1" : "0",
    });
