...
class KlaimAsuransiUpdate extends StatefulWidget {
  final int id;
  KlaimAsuransiUpdate({this.id});
  @override
  _KlaimAsuransiUpdateState createState() => _KlaimAsuransiUpdateState(id: id);
}

class _KlaimAsuransiUpdateState extends State<KlaimAsuransiUpdate> {
  final int id;
