...
class HarianDetailMngRTPKChart extends StatefulWidget {
  HarianDetailMngRTPKChart({this.title, this.period, this.custID});
  final String title;
  final String period;
  final String custID;
  @override
  HarianDetailMngRTPKChartState createState() =>
      HarianDetailMngRTPKChartState(title, period, this.custID);
}

class HarianDetailMngRTPKChartState extends State<HarianDetailMngRTPKChart> {
  final String title;
  final String period;
  final String custID;

  HarianDetailMngRTPKChartState(this.title, this.period, this.custID);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            _buildContent(context, fetchPost(context, period, custID)),
          ],
        ),
      ),
    );
