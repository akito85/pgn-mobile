...
import 'package:pgn_mobile/models/sales_area_model.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SalesArea extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        title: Text(
          Translations.of(context).text('title_bar_gus_area'),
  ...
  Widget _buildContent(
      BuildContext context, Future<GetSalesArea> getSalesArea) {
    return FutureBuilder<GetSalesArea>(
      future: getSalesArea,
      builder: (context, snapshot) {
        ...
        return Column(
          ...
          children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Container(
                        width: 140,
                        margin:
                            EdgeInsets.only(left: 20.0, top: 10, bottom: 15.0),
                        child: Text(
                          Translations.of(context)
                      ...
                      Container(
                        margin:
                            EdgeInsets.only(left: 35.0, top: 10, bottom: 15.0),
                        child: Text(
                          ':',
                          style: TextStyle(
                              fontSize: 13.0,
                      ...
                      Expanded(
                        child: Container(
                          margin:
                              EdgeInsets.only(left: 5.0, top: 10, bottom: 15.0),
                          child: Text(
            ...
            Container(
              margin: EdgeInsets.only(top: 5.0, left: 15),
              child: Text(
                Translations.of(context).text('f_monthly_revenue_detail_area'),
                style: TextStyle(
  ...
  Widget _buildRow(ChartSalesArea data) {
    return Padding(
      ...
      child: new LinearPercentIndicator(
        ...
        center: Container(
          ...
          child: Text(
            ...
            style: TextStyle(fontSize: 11, color: Color(0xFF5C727D)),
          ),
        ),
...
Future<GetSalesArea> fetchPost(BuildContext context) async {
  ...
  return GetSalesArea.fromJson(json.decode(responseGetSalesArea.body));
}
