...
import 'package:pgn_mobile/screens/smartmeter_rtpk/smartmeter_rtpk_detail.dart';
import 'package:pgn_mobile/services/app_localizations.dart';
import 'package:flutter/painting.dart' as painting;
import 'package:http/http.dart' as http;

class UsageDetailRTPK extends StatefulWidget {
  final String title, idCust;
  UsageDetailRTPK({this.idCust, this.title});

  @override
  _UsageDetailRTPKState createState() => _UsageDetailRTPKState(title, idCust);
}

class _UsageDetailRTPKState extends State<UsageDetailRTPK>
    with TickerProviderStateMixin {
  final String idCust, title;
  final dataJuni00056384 = """{
    "data": [
        {
            "date": {
                "value": "2021-06-07",
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HarianDetailRTPKChart(
  ...
  Future<ChartUsageDetailSmartmeter> fetchGetChar(
    ...
    var responseUsageChar = await http.get(
      '${UrlCons.mainProdUrl}customers/me/gas-usages/smart-meter-chart/$title',
      headers: {
