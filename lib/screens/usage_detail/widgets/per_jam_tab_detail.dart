...
class PerJamTabDetail extends StatefulWidget {
  final String title, idCust;
  PerJamTabDetail({this.title, this.idCust});
  @override
  PerJamTabDetailState createState() => PerJamTabDetailState(title, idCust);
}

class PerJamTabDetailState extends State<PerJamTabDetail> {
  final String title, idCust;
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                Translations.of(context)
                                    .text('row_hourly_usage_tv_usage_label'),
                                style: TextStyle(
                                    fontSize: 13.0,
                            ...
                            Container(
                              margin: EdgeInsets.only(left: 10.0, top: 23),
                              child: Text(
                                ':',
                                style: TextStyle(
                                    fontSize: 13.0,
