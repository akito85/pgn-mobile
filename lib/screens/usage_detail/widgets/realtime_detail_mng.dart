...
class RealtimeDetailMngChart extends StatefulWidget {
  RealtimeDetailMngChart({this.title, this.custID});
  final String title;
  final String custID;
  @override
  RealtimeDetailMngChartState createState() =>
      RealtimeDetailMngChartState(title, custID);
}

class RealtimeDetailMngChartState extends State<RealtimeDetailMngChart> {
  final String title;
  final String custID;
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildContent(context, fetchPost(context, custID)),
          ],
        ),
      ),
    );
...
Future<ChartUsageDetailRealtimeDetail> fetchPost(
  ...
  var responseDailyUsage = await http.get(
    '${UrlCons.mainProdUrl}customers/$custID/gas-usages/realtime-list',
    headers: {
...
void _downloadPDF(BuildContext context, String custID) async {
  final storageCache = FlutterSecureStorage();
  String accessToken = await storageCache.read(key: 'access_token');
  String lang = await storageCache.read(key: 'lang');
  var responseDailyUsage = await http.get(
