...
class PenurunanTab extends StatefulWidget {
  @override
  PenurunanTabState createState() => PenurunanTabState();
}

class PenurunanTabState extends State<PenurunanTab> {
  @override
  ...
  Widget _buildContent(
      BuildContext context, Future<DownUsageDetail> getDownUsageDetail) {
    return FutureBuilder<DownUsageDetail>(
      future: getDownUsageDetail,
  ...
  Widget _buildRow(DataDownUsage data) {
    return Column(
      children: <Widget>[
        InkWell(
          child: Card1(data),
                  ...
                  Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Text(
                          Translations.of(context)
                              .text('row_gain_usage_tv_difference_down_label'),
                          style: TextStyle(
                              fontSize: 13.0,
                              fontWeight: FontWeight.w400,
                              color: Colors.grey[600]),
