class CustomerInvoiceResidential{
  ...
  static List<DataCustInvoiceResidential> parseDataInvoiceResidential(datasJson) {
...
class DataCustInvoiceResidential {
  ...
  DataCustInvoiceResidential({this.arrersIdr, this.arrersUsd, this.custInvoiceId, this.custInvoiceName,
  this.custInvoicePeriod, this.custVolUsage, this.invoiceId, this.invoicePeriod, this.isPaid,
  this.pGuaranteeIdr, this.pGuaranteeUsd, this.tBillIdr, this.type, this.usagePeriod});
